...
class SubscriptionForm(forms.Form):
    ...
    email = forms.EmailField(max_length=80, required=True, label='อีเมล')
    ...
    accepted = forms.BooleanField(required=True, label='ข้อความยาวๆ ที่หลายคนเคยเจอ อาจไม่ต้องอ่านก็ได้แค่ยอมรับและเข้าใจก็พอ')
